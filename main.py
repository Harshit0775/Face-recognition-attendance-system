...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "faceattendancerealtime-b6d8c.appspot.com"
})
    ...
    if faceCurFrame:
        for encodeFace, faceLoc in zip(encodeCurFrame, faceCurFrame):
            ...
            if matches[matchIndex]:
                ...
                # to create green box on detected image face
                y1, x2, y2, x1 = faceLoc
        ...
        if counter != 0:
            ...
            if modeType!=3:
                ...
                if counter <= 10:
                    ...
                    (w, h), _ = cv2.getTextSize(studentInfo['name'], cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, 1)
                    offset = (414-w)//2
